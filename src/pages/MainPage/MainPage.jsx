    ...
    <MainPageWraper>
      <UpWraper>
        ...
        <BottomWrap>
          <FourTab>
            <Dictionary>
              <img src={require("../../assets/dictionary.png")} />
              <div>금융 용어사전</div>
            </Dictionary>
            <MyScript onClick={() => navigate("/mypage")}>
              <img src={require("../../assets/myscript.png")} />
              <div>나의 스크랩</div>
            </MyScript>
            <BestProduct>
              <img src={require("../../assets/bestproduct.png")} />
              <div>인기 금융상품</div>
            </BestProduct>
            <Question>
              <img src={require("../../assets/qna.png")} />
              <div>자주 묻는 질문</div>
            </Question>
          </FourTab>
      ...
      <DownWraper>
        <AllTipWraper>
          ...
          <Tips>
            <Tip>
              <TipTitleWrap>
                <img src={require("../../assets/script.png")} />
              ...
              <BoardWrap>
                ...
                <div>
                  ...
                  당청됐습니다주택청약 당청됐습니다주택청약 당청됐습니다주택청약
                  당청됐습니다주택청약 당청됐습니다주택청약 당청됐습니다주택청약
                  당청됐습니다주택청약 당청됐습니다
                </div>
              </BoardWrap>
