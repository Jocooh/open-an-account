...
export const DEPOSIT_BASE_URL = `http://localhost:3000/http://finlife.fss.or.kr/finlifeapi/depositProductsSearch.json?auth=${API_KEY}&topFinGrpNo=020000&pageNo=1`;
